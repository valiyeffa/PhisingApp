        ...
        <div className="min-h-screen bg-black text-white flex flex-col justify-center items-center p-5">
            <div className="flex items-center gap-[60px] max-w-[1000px] mx-auto mb-[50px] w-full">
                    ...
                    <div className="relative w-[450px] h-[550px]">
                        ...
                        <div className="relative w-full h-full rounded-[20px] overflow-hidden">
                            {screenshots.map((src, index) => (
                                <img
                                    ...
                                    className={`absolute top-0 left-0 w-full h-full object-contain rounded-[20px] transition-opacity duration-1000 ${index === currentSlide ? 'opacity-100' : 'opacity-0'
                                        }`}
                                />
                            ))}
                        </div>
                        ...
                        <div className="absolute top-0 left-0 w-full h-full pointer-events-none">
                            {floatingItems.map((item, index) => (
                                <div
                                    key={index}
                                    className={`absolute text-[40px] ${item.className} ${item.emoji === '✓' ? 'bg-gradient-to-r from-[#ff00ff] to-[#00ffff] bg-clip-text text-transparent' : ''
                                        }`}
                                    style={{
                ...
                <div className="w-[350px]">
                    <div className="p-10 mb-[10px]">
                        <h1 className="text-center text-[48px] mb-[30px] font-normal" style={{ fontFamily: '"Brush Script MT", cursive' }}>
                            Instagram
                        </h1>
                        ...
                        <a href="#" className="text-center text-[#00376b] text-xs no-underline mt-5 block hover:text-[#003d75]">
                            Forgot password?
                        </a>
                    </div>
                </div>
            ...
            <footer className="max-w-[1000px] w-full">
                <div className="flex flex-wrap justify-center gap-[15px] mb-5">
                    {['Meta', 'About', 'Blog', 'Jobs', 'Help', 'API', 'Privacy', 'Terms', 'Locations', 'Instagram Lite', 'Meta AI', 'Meta AI Articles', 'Threads', 'Contact Uploading & Non-Users', 'Meta Verified'].map((link) => (
                        <a key={link} href="#" className="text-[#737373] no-underline text-xs hover:underline">
                            {link}
                        </a>
                    ))}
                </div>
